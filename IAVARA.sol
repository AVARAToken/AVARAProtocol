...
contract DividendTracker is DividendPayingToken {
  ...
  constructor(
    ...
    minimumTokenBalanceForDividends = 100_000 * 10**9; // must hold 100k tokens which equates to 0.0001% of the total AVARA supply
  }
...
interface IAVARA is IERC20, IERC20Metadata {
  ...
  ReentrancyGuard
{
  ...
  constructor(
    ...
    _numTokensSellToAddToLiquidity = (_totalSupply * liquidityThresholdPercentage_) / 100000;
    ...
    onlyRole(DEFAULT_ADMIN_ROLE)
  {
    require(
      ...
      'AVARA: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs'
    );
  ...
  function _setAutomatedMarketMakerPair(address pair, bool value) private {
    require(
      ...
      'AVARA: Automated market maker pair is already set to that value'
    );
    ...
    onlyRole(DEFAULT_ADMIN_ROLE)
  {
    require(
      ...
      'AVARA: The dividend tracker already has that address'
    );
    ...
    require(
      ...
      'AVARA: The new dividend tracker must be owned by the token contract'
    );
